        ...
        <v-col align="start">
          <v-row class="mb-4 ml-0" align="start" justify="space-between">
            <v-col class="ma-0 pa-0">
              ...
              <h4 class="text-subtitle-1 text-grey-darken-2">
                {{ capitalizeFirstLetter($route.params.cidade) }}, {{ pais }}
              </h4>
            </v-col>
          ...
          <v-row class="ml-0">
            <v-col class="ma-0 pa-0" cols="12" lg="6">
              <h3 class="text-h4 mb-2 text-grey-darken-3 font-weight-regular">
                {{ tempo.main.temp.toFixed(0) }} ºC
              </h3>
              <h5 class="text-subtitle-1 mt-1 text-grey-darken-1 font-weight-regular">
            ...
            <v-col class="ma-0 pa-0 text-right" cols="12" lg="6">
              ...
              <h5 class="text-subtitle-1 mt-1 text-grey-darken-1 font-weight-regular">
                GMT {{ tempo.timezone > 0 ? '+' : ''
                }}{{ tempo.timezone != 0 ? tempo.timezone / 3600 : '' }}
              </h5>
            </v-col>
          </v-row>
        </v-col>
